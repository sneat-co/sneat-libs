...
| [Extension contracts monorepo](ext-contracts-monorepo/README.md) | Draft | Consolidate every extension contract package into a single sneat-ext-contracts repository with per-contract independent versioning, superseding the per-extension contract repo convention |
