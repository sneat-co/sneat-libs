...
import { HappeningParticipantsComponent } from './happening-participants.component';

vi.mock('@angular/fire/firestore');

describe('HappeningParticipantsComponent', () => {
  let component: HappeningParticipantsComponent;
  let fixture: ComponentFixture<HappeningParticipantsComponent>;

  beforeEach(waitForAsync(async () => {
    await TestBed.configureTestingModule({
      imports: [HappeningParticipantsComponent],
      providers: [
      ...
      .overrideComponent(HappeningParticipantsComponent, {
        set: { imports: [], schemas: [CUSTOM_ELEMENTS_SCHEMA], template: '' },
      })
      .compileComponents();
    fixture = TestBed.createComponent(HappeningParticipantsComponent);
