...
import { of } from 'rxjs';
import { CalendarAddButtonsComponent } from './calendar-add-buttons.component';

vi.mock('@angular/fire/firestore');

describe('CalendarAddButtonsComponent', () => {
  let component: CalendarAddButtonsComponent;
  let fixture: ComponentFixture<CalendarAddButtonsComponent>;

  beforeEach(waitForAsync(async () => {
    await TestBed.configureTestingModule({
      imports: [CalendarAddButtonsComponent],
      providers: [
        { provide: ClassName, useValue: 'CalendarAddButtonsComponent' },
        {
          provide: ErrorLogger,
      ...
      .overrideComponent(CalendarAddButtonsComponent, {
        set: { imports: [], schemas: [CUSTOM_ELEMENTS_SCHEMA], template: '' },
      })
      .compileComponents();
    fixture = TestBed.createComponent(CalendarAddButtonsComponent);
    component = fixture.componentInstance;
    fixture.componentRef.setInput('$space', { id: 'test-space' });
    fixture.componentRef.setInput('dateID', undefined);
    fixture.componentRef.setInput('weekdayID', undefined);
  }));
